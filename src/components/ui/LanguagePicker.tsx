  ...
  return (
    <div className={`relative inline-flex items-center ${className}`}>
      ...
      <select
        ...
        className="h-9 appearance-none rounded-full border border-outline-variant bg-surface pl-8 pr-7 font-label-md text-label-md text-on-surface outline-none transition-colors focus:border-primary focus:ring-1 focus:ring-primary disabled:opacity-60"
      >
        {LOCALES.map((l) => (
